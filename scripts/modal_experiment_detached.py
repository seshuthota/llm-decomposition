...
DEFAULT_CPU = float(os.environ.get("MODAL_CPU", "8"))
...
app = modal.App("llm-decomposition-detached-experiments")
...
def run_config_remote(
    ...
    return {
        ...
        "cpu": DEFAULT_CPU,
        "timeout": DEFAULT_TIMEOUT,
        "stdout_tail": (stdout_buffer.getvalue() + stderr_buffer.getvalue())[-8000:],
